package ch.icarosdev.imageviewlib;
...
public class PanAndZoomListener implements OnTouchListener {
  ...
  public PanAndZoomListener(View container, View view, int anchor) {
...
//	  {
//	      if(currentZoom == getMinimumZoom())
//	      {
//	    	  ((ImageView) child).setScaleType(ScaleType.CENTER_INSIDE);
//	      }
//	      else
//	      {
//	    	  //((ImageView) child).setScaleType(ScaleType.CENTER_CROP);
//	      }
//	  }
